      ...
      entries: [
        {
          ...
          features: [
            ...
            "Issue 테이블에 어떤 에이전트가 작업 중인지 바로 표시됩니다.",
            "복사한 기록에 각 이벤트의 타임스탬프가 함께 담깁니다.",
            "이제 에이전트에게 로컬 서비스를 실행하게 하고, 작업이 끝난 뒤에도 계속 켜 둘 수 있습니다.",
          ],
          improvements: [
            "에이전트가 외부 CI를 기다리며 멈추지 않고, 바로 끝내고 결과를 알려 줍니다.",
            "에이전트가 코드를 고치거나 테스트하기 전에 프로젝트 의존성을 먼저 준비합니다.",
            "에이전트가 프로젝트의 언어와 테스트 러너에 맞는 명령으로 대상을 좁힌 테스트를 실행합니다.",
            ...
            "Issue를 더 불러올 때 '불러오는 중…'이 표시되고, 끝에 도달하면 알려 줍니다.",
          ],
          fixes: [
            "보드와 리스트에서 스크롤로 Issue를 더 불러와도 전체 화면 스켈레톤이 깜빡이지 않습니다.",
        ...
        },
        {
          version: "0.4.9",
          date: "2026-07-23",
          title: "더 풍부한 하위 Issue, Codex 고속 모드, 더 부드러운 UI",
          changes: [],
          features: [
            "이제 Codex 에이전트를 더 빠른 고속 모드로 실행할 수 있습니다.",
            "하위 Issue에 우선순위, 라벨, 진행률, 마감일이 한눈에 표시됩니다.",
            "하위 Issue마다 어떤 정보를 표시할지 고를 수 있습니다.",
          ...
          fixes: [
            ...
            "새 Issue 초안에서 고른 옵션이 더 이상 사라지지 않습니다.",
