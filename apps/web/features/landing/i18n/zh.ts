    ...
    entries: [
      {
        ...
        features: [
          ...
          "Issue 表格现在会直接显示哪些智能体正在处理。",
          "复制的记录现在会带上每条事件的时间戳。",
          "现在可以让智能体启动一个本地服务，并在任务结束后继续保持运行。",
        ],
        improvements: [
          ...
          "滚动加载更多 Issue 时会显示“加载中”，到底部会提示“没有更多了”。",
        ],
        fixes: [
          "在看板和列表里滚动加载更多 Issue 时，不再闪现整页骨架屏了。",
      ...
      },
      {
        version: "0.4.9",
        date: "2026-07-23",
        title: "更丰富的子 Issue、Codex 极速模式，界面更顺手",
        changes: [],
        features: [
          "现在可以用更快的 Codex 极速模式运行智能体了。",
          "子 Issue 现在能直接显示优先级、标签、进度和截止日期。",
          "你可以自选每个子 Issue 要显示哪些信息。",
      ...
      },
      {
        ...
        features: [
          ...
          "现在可以直接在表格视图里添加子 Issue 了。",
        ],
        improvements: [
          "新建的智能体现在会自动获得一个彩色 emoji 头像。",
          "分组的 Issue 表格现在加载更快、也更一致。",
        ],
        fixes: [
          "从大型仓库导入技能不再超时了。",
          "Codex 任务不再卡在第一轮了。",
          "切换账号后，任务会从中断处继续，而不再直接失败。",
          "在表格里编辑单元格不再自己关闭，点击标题即可打开该 Issue。",
          "打开 Issue 时，子 Issue 列表现在会保持最新。",
          "Grok 智能体现在能准确上报 token 用量了。",
          "Qwen 智能体现在可以在任务中执行命令、修改文件了。",
          "聊天输入框的格式菜单回来了，你又能清除格式了。",
          "在手机上，My Issues 列表不再卡在刷新状态。",
        ],
      },
      {
        version: "0.4.7",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "现在可以自定义 Issue 表格，自由选择显示哪些列以及排列方式。",
        ],
        improvements: [
          "Issue 一收到新评论或更新，看板和列表就会立即重新排序。",
          "切换项目列表的显示方式现在只需一个下拉菜单。",
          "现在可以直接用发送快捷键创建 Issue。",
      ...
      },
      {
        ...
        improvements: [
          ...
          "现在可以在设置里选择创建 Issue 时显示哪些字段。",
          "Issue 列表页现在能清楚看到当前有多少智能体在工作。",
          "本机后台现在会记住你的启动选项，不用每次重新输入。",
          "小队队长在同一个 Issue 上的后续跟进会接着之前的进度继续。",
      ...
      },
      {
        ...
        fixes: [
          ...
          "创建 Issue 时选择的标签，现在每次都会和 Issue 一起保存。",
      ...
      },
      {
        version: "0.4.2",
        date: "2026-07-15",
        title: "自定义 Issue 字段、成员归属与 Grok 智能体",
        changes: [],
        features: [
          "你现在可以给 Issue 自定义字段了，并直接在列表里看到。",
          "现在能看到每个智能体的运行背后是哪位成员在负责。",
          "你现在可以基于 Grok 搭建智能体了。",
          "智能体列表现在会显示访问范围，还能筛选和批量修改。",
          "点开 Issue 链接现在默认在新标签页打开，可在偏好设置里调整。",
          "你现在可以用命令行直接创建工作区了。",
          "给标签和自定义字段选颜色时，多了随机配色。",
          "命令面板里可以一键折叠或展开一个 Issue 的所有评论。",
      ...
      },
      {
        ...
        fixes: [
          ...
          "运行时离线时，自动化（Autopilot）的「创建 Issue」运行仍然会出现在运行列表里。",
