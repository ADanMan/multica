      ...
      entries: [
        {
          ...
          features: [
            ...
            "Issue テーブルに、どのエージェントが作業中かが直接表示されます。",
            "コピーした記録に、各イベントのタイムスタンプが付くようになりました。",
            "エージェントにローカル サービスを起動させ、タスク終了後もそのまま動かし続けられるようになりました。",
          ],
          improvements: [
            "エージェントが外部 CI の完了を待って止まらなくなり、そのまま完了して報告します。",
            "エージェントは編集やテストを始める前に、プロジェクトの依存関係を用意します。",
            "エージェントがプロジェクトの言語とテスト ランナーに合ったコマンドで、対象を絞ったテストを実行します。",
            ...
            "Issue をさらに読み込むときに「読み込み中…」が表示され、最後まで来たことも分かるようになりました。",
          ],
          fixes: [
            "ボードとリストでスクロールして Issue を追加読み込みしても、全画面のスケルトンが一瞬表示されなくなりました。",
        ...
        },
        {
          version: "0.4.9",
          date: "2026-07-23",
          title: "より詳しいサブ Issue、Codex 高速モード、なめらかな UI",
          changes: [],
          features: [
            "Codex エージェントをより速い高速モードで実行できるようになりました。",
            "サブ Issue に優先度・ラベル・進捗・期限が一目で表示されます。",
            "サブ Issue ごとに表示する項目を選べるようになりました。",
          ...
          fixes: [
            ...
            "新規 Issue の下書きで選んだオプションが失われなくなりました。",
        ...
        },
        {
          version: "0.4.8",
          date: "2026-07-22",
          title: "エージェントごとのスキル切り替え、正確なタブ、安定したタスク",
          changes: [],
          features: [
            "エージェントごとに個々のスキルをオン/オフできるようになりました。",
            "デスクトップのタブに、開いた対象に合ったアイコンとタイトルが表示されます。",
            "テーブル ビューから直接サブ Issue を追加できるようになりました。",
          ],
          improvements: [
            "新しいエージェントに、カラフルな絵文字アバターが自動で割り当てられます。",
            "グループ化した Issue テーブルが、より速く一貫して表示されます。",
          ],
          fixes: [
            "大きなリポジトリからのスキル インポートがタイムアウトしなくなりました。",
            "Codex タスクが最初のターンで止まらなくなりました。",
            "アカウントを切り替えても、タスクは中断したところから再開し、失敗しなくなりました。",
            "テーブルのセル編集が勝手に閉じなくなり、タイトルをクリックすると Issue が開きます。",
            "Issue を開いたとき、サブ Issue の一覧が最新の状態に保たれます。",
            "Grok エージェントがトークン使用量を正確に報告します。",
            "Qwen エージェントがタスク中にコマンド実行やファイル編集をできるようになりました。",
            "チャット入力欄の書式メニューが戻り、書式をクリアできるようになりました。",
            "モバイルで、My Issues の一覧が更新中のまま止まらなくなりました。",
          ],
        },
        {
          version: "0.4.7",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Issue テーブルをカスタマイズし、表示する列とその並び順を自由に選べるようになりました。",
          ],
          improvements: [
            "Issue に新しいコメントや更新が入った瞬間、ボードや一覧が自動で並び替わります。",
            "プロジェクト一覧の表示方法を、シンプルなドロップダウンで切り替えられます。",
            "送信ショートカットで Issue をそのまま作成できるようになりました。",
            "お使いのマシンのエージェント サービスが、タスク終了後も設定した時間だけ起動し続けられます。",
            "Codex タスクが後片付けをして、ディスク容量を空けるようになりました。",
            "エージェント タスクが準備中に止まらなくなり、すぐ始まるか素早く失敗します。",
        ...
        },
        {
          ...
          improvements: [
            "長いエージェント タスクが、短い通信の途切れで失敗しなくなり、再試行して続行します。",
            "Issue の作成時に表示するフィールドを、設定から選べるようになりました。",
            "Issue 一覧ページで、今何体のエージェントが動いているか分かりやすくなりました。",
            "お使いのマシンのエージェント サービスが、起動時のオプションを覚えるようになりました。",
            "同じ Issue でのスクワッド リーダーの続きの作業が、前回の続きから再開します。",
          ...
          fixes: [
            ...
            "Codex エージェントのタスクが、正しい認証情報で実行されるようになりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "タスクをキャンセルしても、エージェントの記録が乱れなくなりました。",
            "複数の Codex タスクを同時に実行しても、互いに詰まらなくなりました。",
            "Issue 内を移動しても、スクロール位置が確実に保たれます。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "コーディング ツールをその場で更新した後も、デーモンが新しい場所を自動で見つけ、タスクが失敗しなくなりました。",
            "順番待ちのタスクが、前のタスクが終わるとすぐに始まります。",
        ...
        },
        {
          ...
          features: [
            ...
            "長い Issue でも、新しいミニマップでコメントのスレッド間をすばやく移動できます。",
            "お使いのマシンに入っているスキルを、アプリからそのまま検索できます。",
            "お好みで、Issue のコメント入力欄をスクロールしても固定したままにできます。",
          ...
          fixes: [
            "Issue をキャンセル済みにしても、そこで実行中のエージェントの作業が中断されなくなりました。",
            "エージェントのタスク記録が、完全で正しい順序のまま保たれるようになりました。",
